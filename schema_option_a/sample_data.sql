...
call create_batch('ek', '2020-04-13 13:30 ET', true, 'normal publish', batch_id);
...
call commit_batch(batch_id, '2020-04-13 16:30 ET');

-- 4/14/20 morning shift
call create_batch('ek', '2020-04-14 9:30 ET', false, 'normal push', batch_id);
...
call add_core_data(batch_id, 'temp_data');
call commit_batch(batch_id, '2020-04-14 11:30 ET');


-- 4/14/20 afternoon shift (in preview)
call create_batch('ek', '2020-04-14 13:30 ET', true, 'normal publish', batch_id);
...
--call commit_batch(batch_id, '2020-04-14 16:30');
